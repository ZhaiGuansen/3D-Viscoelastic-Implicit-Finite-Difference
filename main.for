...
!!Basic variables
      INTEGER::NX=59,NY=59,NZ=59,T0,NT
      integer, parameter :: rk = kind ( 1.0D+00 )
      INTEGER::T,ini_num=1,INI_T=80,IS_INI=0
      ...
      integer::x0(3)=[30,30,30]!Shot point
...
!Time related variables
      ...
      !Run via "run.ps1" after compilation
     ...
     +       REDUCTION(+:XZ)
         ...
         call system_clock(count12,count_rate,count_max)
          ...
          write(*,*) 'pml time consumed (in seconds): ',timespend 
